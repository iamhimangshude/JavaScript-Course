...
const calcTempAmplitudeBug = function (t1, t2) {
  ...
  debugger; // adds a breakpoint in the code execution process.
  let max = 0;
  let min = 0;
...
the problem and break it up into sub-problems!

TEST DATA 1: [17, 21, 23]
TEST DATA 2: [12, 5, -5, 0, 4]

// 1) Unerstanding the problem
...
// - Add ... between elements and start and at end of string.
...
const printForecast = function (arr) {
  ...
  for (let temp = 0; temp < arr.length; temp++) {
    const outputString = ` ${arr[temp]}℃ in ${temp + 1} days ...`;
